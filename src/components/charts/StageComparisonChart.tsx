...
const StageComparisonChart: React.FC = () => {
  const { stagewiseData } = useProjectData();
        ...
        >
          ...
          >
            <LabelList 
              dataKey="planned" 
              position="top" 
              formatter={(value: number) => value === 100 ? "100" : value.toFixed(0)}
              style={{ fontSize: '10px' }}
            />
          </Bar>
          <Bar 
...
export default StageComparisonChart;